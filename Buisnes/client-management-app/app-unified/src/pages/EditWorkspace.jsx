  ...
  const loadData = async () => {
    try {
      ...
      setFormData({
        ...
        client_id: workspaceData.client_id || '',
      });
  ...
  return (
    <Layout>
      <div className="max-w-2xl mx-auto space-y-6">
        <Link to={`/workspaces/${id}`} className="text-indigo-600 hover:text-indigo-800">← Back to Workspace</Link>
        <div className="bg-white rounded-lg shadow p-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-6">Edit Workspace</h1>
